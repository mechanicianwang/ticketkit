...
That is the situation this was built for. Here is a real audit of one repo's
`docs/` folder, which is where the idea came from:

| unchecked | checked | file |
|---:|---:|---|
| 285 | **0** | `testing-checklist.md` |
| 72 | **0** | `LANGUAGETOOL_INTEGRATION_TODO.md` |
| 37 | **0** | `ielts-practice-hub-plan.md` — *the work had actually shipped* |
